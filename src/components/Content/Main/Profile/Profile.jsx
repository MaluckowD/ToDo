    ...
    <div className={s.settings_item}>
      <div className={s.container}>
        ...
        <div className={isDialogOpen || isDialogOpen1 ? [s.content, s.block].join(" ") : [s.content]}>
          <UserInfo avatarId={props.userData.id} setIsDialogOpen={setIsDialogOpen} name={props.name} surname={props.surname} gender={props.gender} updateUserDataInApp={props.updateUserDataInApp} />
