...
const Main = (props) => {
  return (
    <main className={s.main}>
      <Routes>
        <Route index element={<Calendar getTaskStatus={props.getTaskStatus} statusId={props.statusId} completed={props.completed} getTaskInfo={props.getTaskInfo} getToken={props.getToken} openTaskInfo={props.openTaskInfo} addTask={props.addTask} />} />
