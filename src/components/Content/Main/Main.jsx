...
const Main = (props) => {
  ...
  return (
    <main className = {s.main}>
      <Routes>
        <Route index element={<Calendar getTaskInfo = {props.getTaskInfo} getToken={props.getToken} openTaskInfo={props.openTaskInfo} addTask={props.addTask} tasks = {props.tasks} />} />
